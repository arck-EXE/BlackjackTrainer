...
public class GameVisualManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        _hitBtn.clicked += () =>
        {
            ActionBtnClicked?.Invoke(this, new() { Action = GameAction.Hit });
        };

        _standBtn.clicked += () =>
        {
            ActionBtnClicked?.Invoke(this, new() { Action = GameAction.Stand });
        };

        _splitBtn.clicked += () =>
        {
            ActionBtnClicked?.Invoke(this, new() { Action = GameAction.Split });
        };

        _doubleDownBtn.clicked += () =>
        {
            ActionBtnClicked?.Invoke(this, new() { Action = GameAction.DoubleDown });
        };
